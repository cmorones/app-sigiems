...
foreach ($inventario as $key => $value) {
 ...
 LEFT JOIN niveles n ON z.id_nivel=n.id_nivel  
 where 
 bm.id_situacion_bien IN(1) and cbsdlle.descripcion='$value[cbsdllelargo]'  and bm.clave_cabms='5151000138' and  (bm.fecha_alta < '2008-01-01')";
...
$equipos2007 = \Yii::$app->db2->createCommand($query2007)->queryOne();
 ...
 LEFT JOIN niveles n ON z.id_nivel=n.id_nivel  
 where 
 bm.id_situacion_bien IN(1)  and cbsdlle.descripcion='$value[cbsdllelargo]'  and bm.clave_cabms='5151000138' and  (bm.fecha_alta BETWEEN '2008-01-01' and '2008-12-31')";
...
$equipos2008 = \Yii::$app->db2->createCommand($query2008)->queryOne();
 ...
 LEFT JOIN niveles n ON z.id_nivel=n.id_nivel  
 where 
 bm.id_situacion_bien IN(1)  and cbsdlle.descripcion='$value[cbsdllelargo]'  and bm.clave_cabms='5151000138' and  (bm.fecha_alta BETWEEN '2009-01-01' and '2009-12-31')";
...
$equipos2009 = \Yii::$app->db2->createCommand($query2009)->queryOne();
 ...
 LEFT JOIN niveles n ON z.id_nivel=n.id_nivel  
 where 
 bm.id_situacion_bien IN(1)  and cbsdlle.descripcion='$value[cbsdllelargo]'  and bm.clave_cabms='5151000138' and  (bm.fecha_alta BETWEEN '2010-01-01' and '2010-12-31')";
...
$equipos2010 = \Yii::$app->db2->createCommand($query2010)->queryOne();
 ...
 LEFT JOIN niveles n ON z.id_nivel=n.id_nivel  
 where 
 bm.id_situacion_bien IN(1)  and cbsdlle.descripcion='$value[cbsdllelargo]'  and bm.clave_cabms='5151000138' and  (bm.fecha_alta BETWEEN '2011-01-01' and '2011-12-31')";
...
$equipos2011 = \Yii::$app->db2->createCommand($query2011)->queryOne();
 ...
 LEFT JOIN niveles n ON z.id_nivel=n.id_nivel  
 where 
 bm.id_situacion_bien IN(1)  and cbsdlle.descripcion='$value[cbsdllelargo]'  and bm.clave_cabms='5151000138' and  (bm.fecha_alta BETWEEN '2012-01-01' and '2012-12-31')";
...
$equipos2012 = \Yii::$app->db2->createCommand($query2012)->queryOne();
 ...
 LEFT JOIN niveles n ON z.id_nivel=n.id_nivel  
 where 
 bm.id_situacion_bien IN(1)  and cbsdlle.descripcion='$value[cbsdllelargo]'  and bm.clave_cabms='5151000138' and  (bm.fecha_alta BETWEEN '2013-01-01' and '2013-12-31')";
...
$equipos2013 = \Yii::$app->db2->createCommand($query2013)->queryOne();
 ...
 LEFT JOIN niveles n ON z.id_nivel=n.id_nivel  
 where 
 bm.id_situacion_bien IN(1)  and cbsdlle.descripcion='$value[cbsdllelargo]'  and bm.clave_cabms='5151000138' and  (bm.fecha_alta BETWEEN '2014-01-01' and '2014-12-31')";
...
$equipos2014 = \Yii::$app->db2->createCommand($query2014)->queryOne();
 ...
 LEFT JOIN niveles n ON z.id_nivel=n.id_nivel  
 where 
 bm.id_situacion_bien IN(1)  and cbsdlle.descripcion='$value[cbsdllelargo]'  and bm.clave_cabms='5151000138' and  (bm.fecha_alta BETWEEN '2015-01-01' and '2015-12-31')";
...
$query2016 = "select 
 ...
 LEFT JOIN niveles n ON z.id_nivel=n.id_nivel  
 where 
 bm.id_situacion_bien IN(1)  and cbsdlle.descripcion='$value[cbsdllelargo]'  and bm.clave_cabms='5151000138' and  (bm.fecha_alta BETWEEN '2016-01-01' and '2016-12-31')";
...
$query2017 = "select 
 ...
 LEFT JOIN niveles n ON z.id_nivel=n.id_nivel  
 where 
 bm.id_situacion_bien IN(1)  and cbsdlle.descripcion='$value[cbsdllelargo]'  and bm.clave_cabms='5151000138' and  (bm.fecha_alta BETWEEN '2017-01-01' and '2017-12-31')";
