    ...
    <div class="row">
          ...
          <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                             ...
                                             <?= $form->field($model, 'event_start_date', ['inputOptions'=>[ 'class'=>'form-control'] ] )->textInput(['maxlength' => 35])->widget(DateTimePicker::classname(),
      [
      'type' => DateTimePicker::TYPE_INPUT,
      'options' => ['placeholder' => '', 'readOnly' => false],
      'pluginOptions' => [
        'autoclose' => true,
        'maxView' => 0,
        'startView' => 0,
      ...
      <div class="form-group">
                                            <label for="cname" class="control-label col-lg-2">Fecha Terminal:</label>
                                            <div class="col-lg-4">
                                              

                                             <?= $form->field($model, 'event_end_date', ['inputOptions'=>[ 'class'=>'form-control'] ] )->textInput(['maxlength' => 35])->widget(DateTimePicker::classname(),
                                              [
      'type' => DateTimePicker::TYPE_INPUT,
      'options' => ['placeholder' => '', 'readOnly' => false],
      'pluginOptions' => [
    ...
    <tbody>
      ...
      <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                             ...
                                             <? echo $form->field($model, 'laptop')->checkBox(['uncheck' => "0", 'checked' => "1"]); 
          ?>
                                            </div>
                                            </div>
                                            </td>
         ...
         <tr> <td><div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                             ...
                                             <? echo $form->field($model, 'video_proye')->checkBox(['uncheck' => "null", 'checked' => "true"]); 
          ?>
                                            </div>
                                            </div>
                                            </td>
          ...
          ->checkBox(['uncheck' => "null", 'checked' => "true"]); 
          ?>
                                            </div>
                                            </div></td>
              <td><div class="form-group">
