...
use app\modules\soporte\models\CatTipoServer;
use app\modules\soporte\models\StatusServer;
      ...
      <div class="row">
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            <div class="panel-heading"><h3 class="panel-title">Agregar/modificar Servidores</h3></div>
                                ...
                                <div class="form">
                                    <form class="cmxform form-horizontal tasi-form" id="commentForm" method="get" action="#" novalidate="novalidate">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                     <?= $form->field($model, 'id_tipo', ['inputOptions'=>[ 'class'=>'form-control', 'placeholder' => 'tipo'] ] )->dropDownList(ArrayHelper::map(app\modules\soporte\models\CatTipoServer::find()->where(['tipo'=>1])->orderBy(['id'=>SORT_ASC])->all(),'id','nombre'),['prompt'=>Yii::t('app', '--- Selecciona tipo ---')])->label(false); ?>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="curl" class="control-label col-lg-2">Marca</label>
                                            <div class="col-lg-4">
                                                 <?= $form->field($model, 'marca', ['inputOptions'=>[ 'class'=>'form-control', 'placeholder' => 'tipo'] ] )->dropDownList(ArrayHelper::map(app\modules\soporte\models\CatMserver::find()->where(['tipo'=>1])->orderBy(['id'=>SORT_ASC])->all(),'id','nombre'),
                                                 [
                                                    'prompt'=>Yii::t('app', '--- Selecciona Marca ---'),
                                                   'onchange'=>'
                                                        $.post( "'.Yii::$app->urlManager->createUrl('soporte/inv-servers/modelos?id=').'"+$(this).val(), function( data ) {
                                                          $( "select#invservers-modelo" ).html( data );
                                                        });
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                 <?= $form->field($model, 'modelo', ['inputOptions'=>[ 'class'=>'form-control', 'placeholder' => 'modelo'] ] )->dropDownList(ArrayHelper::map(app\modules\soporte\models\CatModserver::find()->orderBy(['id'=>SORT_ASC])->all(),'id','modelo'),['prompt'=>Yii::t('app', '--- Selecciona modelo ---')])->label(false); ?>
                                            </div>
                                        </div>
                                          <div class="form-group">
                                          ...
                                          <div class="form-group">
                                           ...
                                           <div class="form-group">
                                            <label for="ccomment" class="control-label col-lg-1">Funcionalidad</label>
                                            <div class="col-lg-4">
                                                <?= $form->field($model, 'status', ['inputOptions'=>[ 'class'=>'form-control', 'placeholder' => 'estado'] ] )->dropDownList(ArrayHelper::map(app\modules\soporte\models\StatusServer::find()->orderBy(['id'=>SORT_ASC])->all(),'id','nombre'),['prompt'=>Yii::t('app', '--- Selecciona tipo de funcionalidad ---')])->label(false); ?>
                                            </div>
                                        </div>
